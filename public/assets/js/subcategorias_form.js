/**
 * JavaScript para formulário de subcategorias
 */
(function() {
    'use strict';
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const inputNome = document.getElementById('inputSubcategoriaNome');
        const inputMetaLink = document.getElementById('inputSubcategoriaMetaLink');
